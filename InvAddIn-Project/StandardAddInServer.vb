...
Namespace BomQtyManager
    <ProgIdAttribute("BomQtyManager.StandardAddInServer"),
    GuidAttribute("6EBA9457-2AAF-4C87-849D-1778587B4A9D")>
...
#Region "ApplicationAddInServer Members"
        ...
        Public Sub Activate(ByVal addInSiteObject As Inventor.ApplicationAddInSite, ByVal firstTime As Boolean) Implements Inventor.ApplicationAddInServer.Activate
            ...
            Dim largeIcon As stdole.IPictureDisp = PictureDispConverter.ToIPictureDisp(My.Resources.ButtonIcon32x32)
            Dim smallIcon As stdole.IPictureDisp = PictureDispConverter.ToIPictureDisp(My.Resources.ButtonIcon16x16)
            Dim controlDefs As Inventor.ControlDefinitions = g_inventorApplication.CommandManager.ControlDefinitions
            m_sampleButton = controlDefs.AddButtonDefinition("BomQtyManager", "Internal Name", CommandTypesEnum.kShapeEditCmdType, AddInClientID)

            m_sampleButton.StandardIcon = smallIcon
...
#Region "Function to get the add-in client ID."
    ...
    Public Function AddInClientID() As String
        Dim guid As String = ""
        Try
            Dim t As Type = GetType(BomQtyManager.StandardAddInServer)
